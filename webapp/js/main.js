...
var Upperlim, affpgcount, currpg, extendaff, keydownhandler, lowerlim, maxchar, maxpgrenum, newaffpage, pnnum, pnrenum, pxtopt;
...
keydownhandler = function(event) {
  var extratxt, node, nodeta, psib, rmpg, temp, txt;
  if (event.which === 8) {
